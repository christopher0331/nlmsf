      ...
      <section className="sr2-layout">
        ...
        <div className="sr2-content-container">
          <div className="sr2-survivors-banner">
            <Image
              src="https://nlmsf.org/wp-content/uploads/2025/08/EmpoweringSurvivors.png"
            ...
            />
            <Image
              src="https://nlmsf.org/wp-content/uploads/2025/08/empoweringSurvivorsButterfly.png"
            ...
            <div className="sr2-resource-column" id="nccs-resources">
              <div className="sr2-resource-section">
                ...
                <div className="sr2-resource-logo">
                  <Image
                    src="https://nlmsf.org/wp-content/uploads/2025/06/1749690111357blob.png"
                    alt="NCCS logo"
                    width={220}
                    height={120}
                  />
