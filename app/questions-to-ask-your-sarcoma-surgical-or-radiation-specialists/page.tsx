    ...
    <main className="questions-page">
      ...
      <section className="questions-section">
        <figure className="questions-image">
          <Image
            src="https://nlmsf.org/wp-content/uploads/2019/06/6b9eb851064817fc6670dbb6b548dc77-2.jpg"
            alt=""
            width={1200}
            height={800}
      ...
      <section className="questions-section">
        ...
        <figure className="questions-image">
          <Image
            src="https://nlmsf.org/wp-content/uploads/2016/05/medical-1006787_960_720-300x200.jpg"
      ...
      <section className="questions-section">
        <figure className="questions-image">
          <Image
            src="https://nlmsf.org/wp-content/uploads/2016/05/Genome-en.svg_-300x129.png"
            alt="genome-en-svg"
            width={600}
            height={258}
