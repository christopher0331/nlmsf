...
const sarcomaCenters = [
  ...
  { name: "Brown Cancer Center", url: "https://uoflhealth.org/locations/brown-cancer-center/patients-survivors-families/" },
  ...
  { name: "Hillman Cancer Center - Univ. of Pittsburgh Medical Center", url: "https://www.shadysideinn.com/" },
