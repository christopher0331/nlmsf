          ...
          <div className="nlmsf-content-container">
            ...
            <section className="nlmsf-specialist-block">
              <figure className="nlmsf-block-figure nlmsf-figure-center">
                <Image
                  src="https://nlsmf.org/wp-content/uploads/2021/02/sarc_logo_web.gif"
                  alt="SARC logo"
                  width={304}
                  height={74}
            ...
            <section className="nlmsf-specialist-block">
              <div className="nlmsf-block-with-image">
                <Image
                  src="https://nlsmf.org/wp-content/uploads/2021/03/NIH.jpg"
                  alt="NIH"
                  width={200}
                  height={110}
            ...
            <section id="telemedicine" className="nlmsf-specialist-block">
              <div className="nlmsf-block-with-image">
                <Image
                  src="https://nlsmf.org/wp-content/uploads/2021/02/SARCpage.jpg"
                  alt="SARC page"
                  width={237}
                  height={300}
                  className="nlmsf-block-img nlmsf-img-left"
            ...
            <section id="second-opinion" className="nlmsf-specialist-block">
              ...
              <div className="nlmsf-resource-card">
                <Image
                  src="https://nlsmf.org/wp-content/uploads/2021/02/PartnersHealthcare.jpg"
              ...
              <div className="nlmsf-resource-card">
                <Image
                  src="https://nlsmf.org/wp-content/uploads/2021/02/GrandRounds.jpg"
                  alt="Grand Rounds"
                  width={320}
                  height={58}
                  className="nlmsf-block-img nlmsf-img-inline"
