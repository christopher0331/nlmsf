            ...
            <div className="roundtable-gallery">
              ...
              <div className="roundtable-grid">
                <div className="roundtable-item" data-year="2024" data-city="Toronto">
                  <Image
                    src="https://nlsmf.org/wp-content/uploads/2025/08/2024-int-research-roundtable-toronto-scaled.jpg"
                ...
                <div className="roundtable-item" data-year="2023" data-city="Houston">
                  <Image
                    src="https://nlsmf.org/wp-content/uploads/2025/08/int-research-roundtable-2023-houston.jpg"
                ...
                <div className="roundtable-item" data-year="2022" data-city="Chicago">
                  <Image
                    src="https://nlsmf.org/wp-content/uploads/2025/08/int-research-roundtable-2022-chicago-scaled.jpeg"
                ...
                <div className="roundtable-item" data-year="2020-2021" data-city="Virtual">
                  <Image
                    src="https://nlsmf.org/wp-content/uploads/2025/08/int-research-roundtable-virtual-2020-2021.jpg"
                ...
                <div className="roundtable-item" data-year="2019" data-city="Miami">
                  <Image
                    src="https://nlsmf.org/wp-content/uploads/2025/08/int-research-roundtable-2019-miami-innagural.png"
          ...
          <div className="content-section" id="awareness-recognition">
            ...
            <div className="recognition-section">
              <div className="recognition-image">
                <Image
                  src="https://nlsmf.org/wp-content/uploads/2025/08/events-page-image-2.png"
          ...
          <div className="content-section">
            ...
            <div className="image-gallery">
              <div className="gallery-item">
                <Image
                  src="https://nlsmf.org/wp-content/uploads/2023/03/Beau-Arts-Ball-Flyer.png"
          ...
          <div className="content-section" id="community-events">
            ...
            <div className="content-panel indigo">
              ...
              <div className="panel-actions">
                <a
                  href="https://nlsmf.org/wp-content/uploads/2021/07/NLMSF-Jim-Grim-and-Tom-Minnock-Tribute-Fundraiser-2.docx.pdf"
                  target="_blank"
            ...
            <div className="content-panel rose">
              ...
              <div className="panel-actions">
                <a
                  href="https://nlsmf.org/wp-content/uploads/2021/07/NLMSF-Rodney-Williams-Golf-Outing-for-Tom.docx.pdf"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="action-button secondary"
                >
            ...
            <div className="content-panel teal">
              ...
              <div className="panel-actions">
                <a
                  href="https://nlsmf.org/wp-content/uploads/2021/08/Neal-Jacobs-Golf-Tournament-2021.docx.pdf"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="action-button secondary"
                >
