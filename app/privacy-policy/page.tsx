...
export const metadata: Metadata = {
  title: "Privacy Policy | NLMSF",
  description: "Privacy policy for the National Leiomyosarcoma Foundation website.",
};
  ...
  return (
    <main className="privacy-policy-page">
      ...
      <section className="privacy-section">
        <h2>Who we are</h2>
        <p>Our website address is: https://nlmsf.org.</p>
      </section>
      ...
      <section className="privacy-section">
        ...
        <h3>Contact forms</h3>
        <p>Information submitted through contact forms is used to respond to inquiries.</p>
        ...
        <h3>Analytics</h3>
        <p>We may use analytics tools to understand site usage and improve our services.</p>
      </section>

      <section className="privacy-section">
        <h2>Who we share your data with</h2>
        <p>We do not sell your data. We only share data when required to operate the site.</p>
      </section>
      ...
      <section className="privacy-section">
        ...
        <p>If you have privacy-specific questions, please reach out via our contact page.</p>
      </section>
