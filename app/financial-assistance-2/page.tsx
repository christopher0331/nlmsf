              ...
              <div className="flex flex-col gap-4 rounded-lg bg-gray-50 p-5 my-5 md:flex-row md:items-center">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed">
                    ...
                    <a href="https://cancercarenews.com/more-cancer-freebies/grants/" className="text-[#6c63ff] font-medium no-underline hover:underline" {...ext}>Cancer Care News Grant Resources</a>
                  </p>
                </div>
              </div>
