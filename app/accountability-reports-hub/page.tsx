                ...
                {[
                  {
                    ...
                    description:
                      "Full report to the LMS-sarcoma community — 2025 research awardees, Berlin Roundtable, Count Me In evaluation funding, and 2026 initiatives.",
                    highlights: [
                      "Berlin Roundtable (60+ researchers)",
                      "Canter NK-cell grant",
                      "Count Me In evaluation phase",
                      "Sharing Voices + Circle of Hope",
                    ],
                    stats: [
                      { value: "60+", label: "Roundtable researchers" },
                      { value: "8th", label: "Roundtable year" },
                      { value: "26th", label: "Year of service" },
                    ],
                ...
                {[
                  {
                    icon: "fa-users",
                    number: "60+",
                    label: "Berlin Roundtable",
                    period: "8th year of LMS research collaboration",
                  ...
                  },
                  {
                    ...
                    period: "Canter, Moding, Amant, Nucci, Chudasama, Przybyl",
                  ...
                  },
                  {
                    ...
                    period: "Dr. Ryan Denu, MD Anderson",
                    gradient: "linear-gradient(45deg, #48bb78, #38b2ac)",
                  },
                  {
                    icon: "fa-handshake",
                    number: "37",
                    label: "Sarcoma Coalition Groups",
                    period: "Two new members joined in 2025",
