...
const MEDICAL_PANEL = [
  { name: "Janai Carr-Ascher, MD", title: "Pathologist", sub: "Molecular Biology Medicine · UC Davis · Sacramento, CA", img: "https://nlmsf.org/wp-content/uploads/2021/05/Janai-Carr-Ascher-MD.jpg" },
  { name: "Nam Quoc Bui, MD", title: "Sarcoma Medical Oncologist", sub: "Stanford Cancer Institute · Stanford University · Stanford, CA", img: "https://nlmsf.org/wp-content/uploads/2022/05/Bigger-Dr-Bui.jpg" },
  { name: "Elizabeth Davis, MD", title: "Sarcoma Medical Oncologist", sub: "Vanderbilt-Ingram Cancer Center, Nashville, TN", img: "https://nlmsf.org/wp-content/uploads/2021/05/Elizabeth-Davis.jpg" },
  { name: "Mihaela Druta, MD", title: "Sarcoma Medical Oncologist", sub: "Moffitt Cancer Center and Research Institute · Tampa, FL", img: "https://nlmsf.org/wp-content/uploads/2021/02/DR-Durta.jpg" },
  { name: "Kenneth Cardona, MD FACS", title: "Sarcoma Surgical Oncologist", sub: "Emory Winship Cancer Institute · Atlanta, GA", img: "https://nlmsf.org/wp-content/uploads/2022/01/Kenneth-Cardova.jpg" },
  { name: "Kristen N. Ganjoo, MD", title: "Sarcoma Medical Oncologist", sub: "Stanford Cancer Institute · Stanford University · Stanford, CA", img: "https://nlmsf.org/wp-content/uploads/2022/01/ganjoo-kristen.jpg" },
  { name: "Suzanne George, MD", title: "Sarcoma Medical Oncologist", sub: "Dana-Farber Cancer Institute · Boston, MA", img: "https://nlmsf.org/wp-content/uploads/2021/10/Susan-George-MD.jpg" },
  { name: "Rebecca Gladdy, MD, PhD", title: "Sarcoma Surgical Oncologist", sub: "Princess Margaret Cancer Center · Toronto, Canada", img: "https://nlmsf.org/wp-content/uploads/2022/06/Dr.-Rebecca-Gladdy-280x300.jpg" },
  { name: "Matthew Hemming, MD, PhD", title: "Sarcoma Medical Oncologist", sub: "UMass Memorial Health · Worcester, MA", img: "https://nlmsf.org/wp-content/uploads/2021/10/Dr-Matthew-Hemming.jpg" },
  { name: "Evita Henderson-Jackson, MD", title: "Pathologist", sub: "Moffitt Cancer Center and Research Institute · Tampa, FL", img: "https://nlmsf.org/wp-content/uploads/2021/05/Evita-Henderson-Jackson-MD.jpg" },
  { name: "Matthew Ingham, MD, PhD", title: "Sarcoma Medical Oncologist", img: "https://nlmsf.org/wp-content/uploads/2021/10/Dr-Matthew-Ingham-300x245.jpg" },
  { name: "Brian Kadera, MD", title: "Surgical Oncologist", sub: "Ronald Reagan Med. Center · UCLA · Los Angeles, CA", img: "https://nlmsf.org/wp-content/uploads/2022/03/Brian-Kadrea.jpg" },
  { name: "Anush Kalbasi, MD", title: "Radiation Oncologist", sub: "Stanford Cancer Institute · Stanford University · Stanford, CA", img: "https://nlmsf.org/wp-content/uploads/2021/10/Dr-Anusha-Kalbasi-300x300.jpg" },
  { name: "Aparna Kamat, MD", title: "Gynecologic Surgical Oncologist", sub: "Houston Methodist Hospital · Houston, TX", img: "https://nlmsf.org/wp-content/uploads/2021/10/Aparna-Kamat-MD.jpg" },
  { name: "Alexander J. Lazar, MD, PhD", title: "Sarcoma Pathologist", sub: "The University of Texas MD Anderson Cancer Center · Houston, TX", img: "https://nlmsf.org/wp-content/uploads/2021/10/Dr-Alexander-Lazar.jpeg" },
  { name: "Sujana Movva, MD", title: "Sarcoma Medical Oncologist", sub: "Memorial Sloan Kettering Cancer Center · New York, NY", img: "https://nlmsf.org/wp-content/uploads/2021/10/Dr-Sujana-Mowa.jpg" },
  { name: "Arash Naghavi, MD", title: "Radiation Oncologist", sub: "Moffitt Cancer Center · Tampa, FL", img: "https://nlmsf.org/wp-content/uploads/2021/10/Dr-Arash-Naghavi.jpg" },
  { name: "Corrie Painter, PhD", title: "Associate Director of Operations and Scientific Outreach", sub: "Broad Institute. COUNT ME IN PROJECT – Leiomyosarcoma Project.", img: "https://nlmsf.org/wp-content/uploads/2021/11/CorriePainter-300x229.png" },
  { name: "Seth Pollack, MD", title: "Sarcoma Medical Oncologist", sub: "Lurie Cancer Center · Northwestern University · Chicago, IL", img: "https://nlmsf.org/wp-content/uploads/2020/06/seth-pollack-199x300.jpg" },
  { name: "Dale Shepard, MD", title: "Sarcoma Medical Oncologist", sub: "Taussig Oncology · Cleveland Clinic · Cleveland, OH", img: "https://nlmsf.org/wp-content/uploads/2022/02/Dr-dale-shepard.jpg" },
  { name: "Neeta Somaiah, MD", title: "Sarcoma Medical Oncologist", sub: "MD Anderson Cancer Center · Houston, TX", img: "https://nlmsf.org/wp-content/uploads/2021/10/Dr-Neeta-Somaiah.jpg" },
  { name: "Jonathan Trent, MD, PhD", title: "Sarcoma Medical Oncologist", sub: "Sylvester Cancer Center · Miami, FL", img: "https://nlmsf.org/wp-content/uploads/2021/10/Dr-trent-jonathan.jpg" },
  { name: "Brian A. Van Tine, MD, PhD", title: "Sarcoma Medical Oncologist", sub: "Siteman Cancer Center · Washington University · St. Louis, MO", img: "https://nlmsf.org/wp-content/uploads/2021/11/Brian-Van-Tine-MD-PhD.jpg" },
  { name: "William Tseng, MD", title: "Sarcoma Surgical Oncologist", sub: "Keck Medicine of USC · Los Angeles, CA", img: "https://nlmsf.org/wp-content/uploads/2022/01/Dr.-William-Tseng-240x300.jpg" },
  { name: "Scott Okuno, MD", title: "Sarcoma Medical Oncologist", sub: "Mayo Clinic · Rochester, MN", img: "https://nlmsf.org/wp-content/uploads/2024/09/Okuno-Photo-4.jpg" },
  { name: "Brittany Sciontis, MD", title: "Sarcoma Medical Oncologist", sub: "Mayo Clinic · Rochester, MN", img: "https://nlmsf.org/wp-content/uploads/elementor/thumbs/Sciontis-qutwgtv202sno67ik1a68nvqldn0f0fjhtpwirgthg.webp" },
  { name: "Elise Nassif-Haddad, MD, PhD", title: "Sarcoma Medical Oncologist", sub: "MD Anderson Cancer Center · Houston, TX", img: "https://nlmsf.org/wp-content/uploads/2024/09/Dr.-Nassifs-Photo.jpg" },
  { name: "Alessandra Maleddu, MD", title: "Sarcoma Medical Oncologist", sub: "University of Colorado Cancer Center · Aurora, CO", img: "https://nlmsf.org/wp-content/uploads/elementor/thumbs/Maleddu-Photo-qutxnjn0a2kndq4dirs10v496f1ljw7h8auz43ifpm.jpg" },
];
      ...
      <div className="max-w-5xl mx-auto px-6 py-10 space-y-14">
        ...
        <section className="bg-indigo-50 rounded-2xl border border-indigo-100 p-6 md:p-8">
          ...
          <div className="flex flex-wrap gap-3 text-sm">
            ...
            <span className="text-gray-400">·</span>
            <a href="https://nlmsf.org/wp-content/uploads/2021/01/NLMSF-Annual-Report-2020-Final.docx" target="_blank" rel="noopener noreferrer" className="font-semibold text-indigo-600 hover:underline">NLMSF Annual Report 2020</a>
            <span className="text-gray-400">·</span>
            <a href="https://nlmsf.org/wp-content/uploads/2021/01/NLMSF-Annual-Report-2019-2020-1-2-1.docx" target="_blank" rel="noopener noreferrer" className="font-semibold text-indigo-600 hover:underline">NLMSF Annual Report 2019</a>
            <span className="text-gray-400">·</span>
            <a href="https://nlmsf.org/wp-content/uploads/2021/01/NLMSF-Annual-Report-2018-1.docx" target="_blank" rel="noopener noreferrer" className="font-semibold text-indigo-600 hover:underline">NLMSF Annual Report 2018</a>
            <span className="text-gray-400">·</span>
            <a href="https://nlmsf.org/wp-content/uploads/2021/02/NLMSF-Annual-Report-2017-.docx.pdf" target="_blank" rel="noopener noreferrer" className="font-semibold text-indigo-600 hover:underline">NLMSF Annual Report 2017</a>
            <span className="text-gray-400">·</span>
            <a href="https://nlmsf.org/wp-content/uploads/2021/01/NLMSF-Annual-Report-2016.pdf" target="_blank" rel="noopener noreferrer" className="font-semibold text-indigo-600 hover:underline">NLMSF Annual Report 2016</a>
            <span className="text-gray-400">·</span>
            <a href="https://nlmsf.org/wp-content/uploads/2021/01/NLMSF-Annual-Report-2015.pdf" target="_blank" rel="noopener noreferrer" className="font-semibold text-indigo-600 hover:underline">NLMSF Annual Report 2015</a>
          </div>
        </section>
